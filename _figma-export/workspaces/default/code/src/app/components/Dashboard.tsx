        ...
        <div className="lg:col-span-3 p-6 bg-white/[0.025] border border-white/[0.06] rounded-xl">
          ...
          <ResponsiveContainer width="100%" height={240}>
            <AreaChart data={revenueData} margin={{ top: 4, right: 0, left: -24, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="revenue" stroke="rgba(255,255,255,0.7)" strokeWidth={1.5} fillOpacity={1} fill="url(#dashboardRevenue)" dot={false} activeDot={{ r: 4, fill: "#fff", strokeWidth: 0 }} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
